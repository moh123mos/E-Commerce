  ...
  <div class="layout">
    ...
    <nav class="">
      ...
      <div class="row me-0">
        ...
        <div
          class="col-5 assissant d-flex justify-content-end align-items-center gap-5"
        >
          <div class="help">
            <div class="icon">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                class="svg-inline--fa fa-user-headset"
                width="20px"
              >
                <path
                  fill="currentColor"
          ...
          <div class="langs">
            <div class="detected d-flex gap-1" style="cursor: pointer">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                version="1.1"
                x="0px"
              ...
              <span class="lang">EN</span>/<span class="currency">USD</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                width="16"
