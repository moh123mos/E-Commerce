<template>
  <div class="features container">
    <!-- trophy -->
    <div class="btn-move prv mobile" @click="changeTransalte(0)">
      <svg
        ref="prvMoveBtn"
        class="prv"
    ...
    <div class="parent py-2">
      <div class="big-child" ref="bigChild">
        <div class="child">
          <div class="icon">
            <svg
              aria-hidden="true"
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 512"
              class="svg-inline--fa fa-shipping-fast fa-w-20 fa-5x"
            >
              <path
                fill="currentColor"
          ...
          <div class="desc">Free Shipping & Returns</div>
        </div>
        <div class="child">
          <div class="icon">
            <svg
          ...
          <div class="desc">Lowest price Guarantee</div>
        </div>
        <div class="child">
          <div class="icon">
            <svg
          ...
          <div class="desc">Longest Warranties Offer</div>
        </div>
      </div>
    </div>
    <div class="btn-move next mobile" @click="changeTransalte(1)">
      <svg
        ref="nextMoveBtn"
        class="next"
        xmlns="http://www.w3.org/2000/svg"
...
let bigChild = ref(null);
let nextMoveBtn = ref(null);
let prvMoveBtn = ref(null);
let translateX = 340;
let cnt = 0;
